...
class Agent:
    ...
    def setup_agent(self):
        ...
        self.critic1 = Critic(hidden_size=256, hidden_layers=2, critic_lr=3e-4, 
                             state_dim=self.state_dim, action_dim=self.action_dim, device=self.device)
    ...
    def train_agent(self):
        ...
        with torch.no_grad():
            ...
            target_q1_next = self.critic_target.criticNetwork(critic_input_next)
            target_q2_next = self.critic_target1.criticNetwork(critic_input_next)
        ...
        current_q1 = self.critic.criticNetwork(critic_input_current)
        current_q2 = self.critic1.criticNetwork(critic_input_current)
        ...
        self.run_gradient_update_step(self.critic1, critic_loss_2)
        ...
        q1_new = self.critic.criticNetwork(critic_input_new_action)
        q2_new = self.critic1.criticNetwork(critic_input_new_action)
        ...
        self.critic_target_update(self.critic.criticNetwork, self.critic_target.criticNetwork, tau=0.005, soft_update=True)
        self.critic_target_update(self.critic1.criticNetwork, self.critic_target1.criticNetwork, tau=0.005, soft_update=True)
